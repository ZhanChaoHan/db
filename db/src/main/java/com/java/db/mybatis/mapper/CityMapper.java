...
import com.java.db.mybatis.factory.CityFactory;
...
public interface CityMapper {
    ...
    @Insert("INSERT INTO city(cityID,cityName,provincialID) VALUES(#{cityID}, #{cityName}, #{provincialID})")
    void insert(CityEntity user);
    @InsertProvider(type = CityFactory.class,method = "insertCity")
    public boolean insertProvider(@Param("bean")CityEntity city);
